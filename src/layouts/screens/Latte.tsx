...
const LatteScreen = ({navigation}:any) => {
  return (
      ...
      <View style={styles.box}>
        ...
        <View style={styles.coffeeDetails}>
          ...
          <View style={{
            ...
            <Text style={{ color: '#996600', fontSize: 15, }}> 4.0</Text>
          </View>
          <View style={styles.volume}>
            <Text style={styles.vol}>Volume </Text>
            <Text style={styles.quantity}> 100 ml</Text>
          </View>
          <View style={styles.price}>
            <Text style={styles.rate}>$12.30</Text>
            <TouchableOpacity
